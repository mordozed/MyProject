        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <!-- Title -->
                    <br>
                    <a href="/HR/employees.jsp" class="btn btn-outline-primary">&laquo; Back</a><br>
                    <h1 class="mt-4">Employee Info</h1>
                        ...
                        <div class="profile-header">
                            <div class="user-detail">
                                ...
                                <div class="user-data">
                                    ...
                                    <h2 id="name" id="surname" ><%= request.getParameter("name")%>  <%= request.getParameter("surname")%></h2>
                                    ...
                                    <br>
                                    <i class="fa fa-map-marker" aria-hidden="true" name="location" id="city" id="state" id="countryName" id="regionName"></i>  <%= request.getParameter("city")%>, <%= request.getParameter("state")%>, <%= request.getParameter("countryName")%>, <%= request.getParameter("regionName")%><br>
                                    <i class="fa fa-id-card-o" aria-hidden="true" name="job" id="job "></i>   <%= request.getParameter("job")%><br>
                                    <i class="fa fa-phone" aria-hidden="true" name="phonenumber" id="phonenumber" ></i>  Contact No: <%= request.getParameter("phonenumber")%><br>
                                ...
                                <div class="social-icons">
                                    ...
                                    <!--<a href="#" type="button" class="msg-btn">-->

                                    <button type="button" class="msg-btn btn btn-info fa fa-envelope-o"> Send Message</button>
                                </div>
                            </div>
